...
async def inline_handler(event):
    ...
    if inline_pic():
        ...
        result = await event.builder.article(
            title="**⌔∮ قائمة أوامر سورس جـاكثون**", text=text, buttons=get_help_buttons()
        )
...
async def help_func(moh):
    ...
    _strings = {
        "basic": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/YamenThon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد القوائم الموجودة: {}**",
        "account": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/YamenThon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
        "fun": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/YamenThon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
        "group":"**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/YamenThon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
    }
...
async def opner(event):
    await event.edit(
        "**⌔∮ القائمة الرئيسية لـ أوامر سورس جـاكثون**\n**❃ مالك الحساب هو: {}.\n❃ عدد القوائم الموجودة: {}**".format( 
            jmubot.full_name,
            len(PLUGINS),
        ),
        buttons=get_help_buttons(),
