"""
❃ `{i}فحص`
    **⌔∮ لـ عرض حالة سورس جـاكثون والاصدار و وقت التشغيل**
...
buttons = [
    [
        Button.url("مجموعة المساعدة", "t.me/xvwwvl"),
        Button.url("قناة السورس", "t.me/xvwwvl"),
    ]
]

alive_txt = """
سورس جـاكثون يعمل بنجاح

  ❃ أصدار جـاكثون - {}
  ❃ أصدار التليليثون - {}
"""

PING_PIC = JmdB.get_key("PING_PIC") or "https://files.catbox.moe/uv47pv.jpg"
JM_TXT = "مهما أجتهدنا في الـنسيان صدفه واحدة تعيد لنـا عمراَ من الذكريات...!!ٌ . .🧸♥️"


in_alive = "{}\n\n❃ <b>إصدار جـاكثون -><b> <code>{}</code>\n❃ <b>إصدار البايثون -></b> <code>{}</code>\n❃ <b>مدة التشغيل -></b> <code>{}</code>\n\n<b>قناة السورس @xvwwvl</b>"
alive_1 = "** سورس  جـاكثون  𝙎𝙊𝙐𝙍𝘾𝙀 𝐉𝐀𝐊يعمـل .. بنجـاح ☑️ 𓆩 **\n\n❃ **مالك الحساب** - `{}`\n❃ **إصدار جـاكثون** - `{}`\n❃ **مدة التشغيل** - `{}`\n❃ **إصدار البايثون** - `{}`\n❃ **إصدار التيليثون** - `{}`\nقنـاة السـورس @xvwwvl"
...
async def alive_func(e):
    ...
    pic = jmdB.get_key("ALIVE_PIC") or "https://files.catbox.moe/uv47pv.jpg"
